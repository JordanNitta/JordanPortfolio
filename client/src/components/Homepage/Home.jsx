...
const Home = () => {
    ...
    return (
        <div className='bg-main-color h-screen flex justify-center items-center box-border overflow-hidden md:justify-center md:items-center lg:justify-start z-50'>
                ...
                <div className="flex flex-col items-center sm:flex-col sm:items-center sm:justify-center md:justify-start md:items-center lg:justify-start lg:items-start">
                    ...
                    <motion.div 
                        ...
                        <button
                            ...
                            <Link to="/contact" className='text-main-color font-semibold font-style text-medium tracking-tighter'>Contact Me</Link>
                        </button>
