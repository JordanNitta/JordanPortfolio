...
const Readmore = ({ onClose }) => {
    return (
        <div className="fixed top-0 mt-[68px] left-4 right-4 h-screen bg-gray-800 z-50 overflow-hidden rounded-main-radius sm:fixed sm:inset-0 sm:flex sm:justify-center sm:w-[60%] sm:mx-auto sm:h-[90%]">
