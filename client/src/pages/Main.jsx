...
const Main = () => {
    ...
    return (
        <div className='bg-main-color h-screen flex justify-center items-center box-border overflow-hidden sm:justify-start'>
            <div className="flex justify-center items-center h-screen sm:ml-60">
                <div className="flex flex-col items-center sm:flex-col sm:items-start sm:justify-start">
                    ...
                    <motion.h2
                        ...
                        className='text-primary-color'>Developer</motion.h2>
                    ...
                    <motion.div 
                        ...
                        <button
                            className='rounded main-radius h-[100%] w-main-button-width relative bg-primary-color' >
                            <Link to="#" className='text-main-color font-semibold font-style text-medium tracking-tighter'>Contact Me</Link>
                        </button>

                        <button className='h-[50px] w-main-button-width border-primary-color rounded-md border-2  flex justify-center items-center'>
                    ...
                    <motion.div 
                        ...
                        <button className='flex items-center justify-center w-[50px] h-[50px] rounded-full border-[2px] border-primary-color'>
                            <a href="" className='flex items-center justify-center w-[150px] h-[100%] '>
                                <FaGithub className='text-primary-color text-[25px]' />
                            </a>
                        </button>
                        <button className='flex items-center w-[50px] h-[50px] rounded-full border-[2px] border-primary-color '>
                            <a href="" className='flex items-center justify-center w-[150px] h-[100%]'>
                    ...
                    <div className>
                        <img src={ProfilePic} className='absolute bottom-0 right-0 h-[600px] mix-blend-overlay filter brightness-125 contrast-60 saturate-20 overflow-hidden'
                        />
                    </div>
